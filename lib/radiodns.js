...
RadioDNS.prototype.resolve = function (params, callback) {
  if (typeof params === 'object') {
    params = this.constructFQDN(params)
  }
...
RadioDNS.prototype.resolveApplication = function (params, app, callback) {
  this.resolve(params, function (err, fqdn) {
    if (err) {
      callback(err)
    } else {
